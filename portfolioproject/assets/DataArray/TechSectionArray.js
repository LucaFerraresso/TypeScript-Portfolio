...
const icons = [
  {
    component: <DiHtml5 color={"var(--color-emerald)"} size={34} />, // Verde smeraldo
    title: "HTML5",
    description:
  ...
  {
    component: <LiaCss3Alt color={"var(--color-red)"} size={34} />, // Rosso acceso
    title: "CSS3",
    description:
  ...
  {
    component: <LiaJsSquare color={"var(--color-yellow)"} size={34} />, // Giallo brillante
    title: "JavaScript",
    description:
  ...
  {
    component: <BiLogoTypescript color={"var(--color-sapphire)"} size={34} />, // Blu zaffiro
    title: "TypeScript",
    description:
  ...
  {
    component: <SiNextdotjs color={"var(--color-foreground)"} size={34} />, // Colore foreground
    title: "Next.js",
    description:
  ...
  {
    component: <BiLogoMongodb color={"var(--color-orange)"} size={34} />, // Arancione
    title: "MongoDB",
    description:
  ...
  {
    component: <BiLogoFirebase color={"var(--color-red)"} size={34} />, // Rosso acceso
    title: "Firebase",
    description:
  ...
  {
    component: <BiLogoTailwindCss color={"var(--color-sapphire)"} size={34} />, // Blu zaffiro
    title: "Tailwind CSS",
    description:
  ...
  {
    component: <DiSass color={"var(--color-berry)"} size={34} />, // Colore bacca audace
    title: "Sass",
    description:
  ...
  {
    component: <Github color={"var(--color-foreground)"} size={34} />, // Colore foreground
    title: "GitHub",
    description:
  ...
  {
    component: <FaNodeJs color={"var(--color-emerald)"} size={34} />, // Verde smeraldo
    title: "Node.js",
    description:
  ...
  {
    component: <LiaNpm color={"var(--color-red)"} size={34} />, // Rosso
    title: "npm",
    description:
  ...
  {
    component: <SiVisualstudiocode color={"var(--color-ocean)"} size={34} />, // Blu oceano vibrante
    title: "VSCode",
    description:
  ...
  {
    component: <SiPostman color={"var(--color-orange)"} size={34} />, // Arancione
    title: "API/REST API",
    description:
  ...
  {
    component: <GiGemini color={"var(--color-berry)"} size={34} />, // Blu oceano vibrante
    title: "Gemini API",
    description:
  ...
  {
    component: <GrReactjs color={"var(--color-ocean)"} size={34} />, // Blu oceano vibrante
    title: "React",
    description:
  ...
  {
    component: <SiVuetify color={"var(--color-sunset-dark)"} size={34} />, // Blu oceano vibrante
    title: "Vue.js",
    description:
      "Vue.js è un framework JavaScript progressivo per la creazione di interfacce utente e applicazioni web, noto per la sua facilità d'integrazione in progetti esistenti grazie alla modularità. Utilizza componenti riutilizzabili e offre data binding reattivo, rendendo le applicazioni scalabili e manutenibili. Il suo ecosistema include strumenti come Vue Router per la gestione delle rotte e Vuex per la gestione dello stato, ed è apprezzato per la sua curva di apprendimento dolce, che lo rende accessibile a sviluppatori di tutti i livelli.",
  },
];
